(self["webpackChunkcalculator_welquer_app"] = self["webpackChunkcalculator_welquer_app"] || []).push([["node_modules_ionic_core_dist_esm_ion-toggle_entry_js"],{
...
/* harmony import */ var _haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./haptic-683b3b3c.js */ 1830);
...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.getSwitchLabelIcon = (mode, checked) => {
      if (mode === 'md') {
        return checked ? _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_1__.f : _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_1__.r;
      }
      return checked ? _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_1__.r : _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_1__.g;
    };
  }
  ...
  renderOnOffSwitchLabels(mode, checked) {
    ...
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", { class: {
  ...
  render() {
    ...
    const { label, labelId, labelText } = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_3__.d)(el, inputId);
    const value = this.getValue();
    (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_3__.e)(true, el, name, checked ? value : '', disabled);
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, "aria-labelledby": label ? labelId : null, "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, role: "switch", class: (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_6__.c)(color, {
        [mode]: true,
        ...
        interactive: true,
      }) }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toggle-icon", part: "track" }, enableOnOffLabels &&
      mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toggle-icon-wrapper" }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toggle-inner", part: "handle" }, enableOnOffLabels && mode === 'md' && this.renderOnOffSwitchLabels(mode, checked)))), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", { htmlFor: inputId }, labelText), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "checkbox", role: "switch", "aria-checked": `${checked}`, disabled: disabled, id: inputId, onFocus: () => this.onFocus(), onBlur: () => this.onBlur(), ref: (focusEl) => (this.focusEl = focusEl) })));
  }
