(self["webpackChunkcalculator_welquer_app"] = self["webpackChunkcalculator_welquer_app"] || []).push([["node_modules_ionic_core_dist_esm_ion-picker-column-internal_entry_js"],{
...
/* harmony import */ var _haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./haptic-683b3b3c.js */ 1830);
...
const PickerColumnInternal = class {
  ...
  componentWillLoad() {
    const visibleCallback = (entries) => {
      ...
      if (ev.isIntersecting) {
         ...
         */
        const oldActive = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).querySelector(`.${PICKER_COL_ACTIVE}`);
  ...
  get activeItem() {
    return (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).querySelector(`.picker-item[data-value="${this.value}"]:not([disabled])`);
  }
  render() {
    const { items, color, isActive, numericInput } = this;
    const mode = (0,_ionic_global_00475c3a_js__WEBPACK_IMPORTED_MODULE_1__.b)(this);
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.H, { tabindex: 0, class: (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_4__.c)(color, {
        [mode]: true,
        ['picker-column-active']: isActive,
        ['picker-column-numeric-input']: numericInput,
      }) }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-item picker-item-empty" }, "\u00A0"), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-item picker-item-empty" }, "\u00A0"), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-item picker-item-empty" }, "\u00A0"), items.map((item, index) => {
      return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { tabindex: "-1", class: {
          'picker-item': true,
    ...
    }), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-item picker-item-empty" }, "\u00A0"), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-item picker-item-empty" }, "\u00A0"), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-item picker-item-empty" }, "\u00A0")));
  }
