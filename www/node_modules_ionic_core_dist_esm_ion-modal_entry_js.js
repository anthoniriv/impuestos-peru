(self["webpackChunkcalculator_welquer_app"] = self["webpackChunkcalculator_welquer_app"] || []).push([["node_modules_ionic_core_dist_esm_ion-modal_entry_js"],{
...
/* harmony import */ var _index_3413f7be_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-3413f7be.js */ 893);
/* harmony import */ var _framework_delegate_ce4f806c_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./framework-delegate-ce4f806c.js */ 6715);
...
/* harmony import */ var _overlays_ab6211c7_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./overlays-ab6211c7.js */ 5526);
/* harmony import */ var _theme_7670341c_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./theme-7670341c.js */ 2187);
/* harmony import */ var _index_7e1d3e32_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index-7e1d3e32.js */ 7751);
...
/* harmony import */ var _index_3f1a7d95_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./index-3f1a7d95.js */ 2503);
...
/* harmony import */ var _gesture_controller_17e82006_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./gesture-controller-17e82006.js */ 9398);
/*!
 * (C) Ionic http://ionicframework.com - MIT License
 */
...
const createSwipeToCloseGesture = (el, animation, onDismiss) => {
  ...
  let lastStep = 0;
  const getScrollY = () => {
    if (contentEl && (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl)) {
  ...
  const canStart = (detail) => {
     ...
     */
    contentEl = (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_2__.f)(target);
    if (contentEl) {
      /**
       ...
       * asynchronous.
       */
      if ((0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl)) {
  ...
  const onStart = (detail) => {
    ...
    if (deltaY > 0 && contentEl) {
      (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_2__.d)(contentEl);
    }
  ...
  const onEnd = (detail) => {
    ...
    if (contentEl) {
      (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_2__.r)(contentEl, initialScrollY);
    }
    animation
      .onFinish(() => {
      if (!shouldComplete) {
...
const Modal = class {
  ...
  initSwipeToClose() {
    ...
    const contentEl = (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_2__.a)(el);
    if (!contentEl) {
      (0,_index_3413f7be_js__WEBPACK_IMPORTED_MODULE_2__.p)(el);
      return;
    }
  ...
  render() {
    ...
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.H, Object.assign({ "no-router": true, "aria-modal": "true", tabindex: "-1" }, htmlAttributes, { style: {
      ...
      }, class: Object.assign({ [mode]: true, ['modal-default']: !isCardModal && !isSheetModal, [`modal-card`]: isCardModal, [`modal-sheet`]: isSheetModal, 'overlay-hidden': true }, (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_8__.g)(this.cssClass)), id: modalId, onIonBackdropTap: this.onBackdropTap, onIonModalDidPresent: this.onLifecycle, onIonModalWillPresent: this.onLifecycle, onIonModalWillDismiss: this.onLifecycle, onIonModalDidDismiss: this.onLifecycle }), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-backdrop", { ref: (el) => (this.backdropEl = el), visible: this.showBackdrop, tappable: this.backdropDismiss, part: "backdrop" }), mode === 'ios' && (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "modal-shadow" }), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { role: "dialog", class: "modal-wrapper ion-overlay-wrapper", part: "content", ref: (el) => (this.wrapperEl = el) }, showHandle && ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { class: "modal-handle",
      // Prevents the handle from receiving keyboard focus when it does not cycle
      tabIndex: !isHandleCycle ? -1 : 0, "aria-label": "Activate to adjust the size of the dialog overlaying the screen", onClick: isHandleCycle ? this.onHandleClick : undefined, part: "handle" })), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null))));
  }
