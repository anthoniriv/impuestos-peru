(self["webpackChunkcalculator_welquer_app"] = self["webpackChunkcalculator_welquer_app"] || []).push([["node_modules_ionic_core_dist_esm_ion-datetime_3_entry_js"],{
...
/* harmony import */ var _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index-45ecc7ca.js */ 9399);
/* harmony import */ var _ionic_global_00475c3a_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ionic-global-00475c3a.js */ 8507);
/* harmony import */ var _focus_visible_5ad6825d_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./focus-visible-5ad6825d.js */ 5763);
/* harmony import */ var _helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers-4d272360.js */ 1978);
...
/* harmony import */ var _parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./parse-d395420d.js */ 1625);
/* harmony import */ var _overlays_ab6211c7_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./overlays-ab6211c7.js */ 5526);
/* harmony import */ var _animation_36c1d77d_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./animation-36c1d77d.js */ 6581);
/* harmony import */ var _haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./haptic-683b3b3c.js */ 1830);
...
const isDayDisabled = (refParts, minParts, maxParts, dayValues) => {
   ...
   */
  if (minParts && (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.i)(refParts, minParts)) {
    return true;
  }
  /**
   ...
   */
  if (maxParts && (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.a)(refParts, maxParts)) {
    return true;
  }
  /**
...
const getCalendarDayState = (locale, refParts, activeParts, todayParts, minParts, maxParts, dayValues) => {
   ...
   */
  const isActive = activePartsArray.find((parts) => (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.b)(refParts, parts)) !== undefined;
  const isToday = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.b)(refParts, todayParts);
  ...
  return {
    ...
    ariaLabel: (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.g)(locale, isToday, refParts),
  };
};
/**
...
const isMonthDisabled = (refParts, { minParts, maxParts, }) => {
  ...
  if ((minParts && (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.i)(refParts, minParts)) || (maxParts && (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.a)(refParts, maxParts))) {
    return true;
  }
  return false;
};
...
const isPrevMonthDisabled = (refParts, minParts, maxParts) => {
  const prevMonth = Object.assign(Object.assign({}, (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.c)(refParts)), { day: null });
...
const isNextMonthDisabled = (refParts, maxParts) => {
  const nextMonth = Object.assign(Object.assign({}, (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.d)(refParts)), { day: null });
...
const Datetime = class {
  constructor(hostRef) {
    ...
    this.ionCancel = (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionCancel", 7);
    ...
    this.ionRender = (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionRender", 7);
    ...
    this.todayParts = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.p)((0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.e)());
    ...
    this.setActiveParts = (parts, removeDate = false) => {
      ...
      if (multiple) {
        ...
        if (removeDate) {
          this.activeParts = activePartsArray.filter((p) => !(0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.b)(p, parts));
        }
    ...
    this.initializeKeyboardListeners = () => {
      ...
      calendarBodyRef.addEventListener('keydown', (ev) => {
        ...
        const parts = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.f)(activeElement);
        let partsToFocus;
        switch (ev.key) {
          case 'ArrowDown':
            ev.preventDefault();
            partsToFocus = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.n)(parts);
            break;
          case 'ArrowUp':
            ev.preventDefault();
            partsToFocus = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.m)(parts);
            break;
          case 'ArrowRight':
            ev.preventDefault();
            partsToFocus = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.l)(parts);
            break;
          case 'ArrowLeft':
            ev.preventDefault();
            partsToFocus = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.k)(parts);
            break;
          case 'Home':
            ev.preventDefault();
            partsToFocus = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.j)(parts);
            break;
          case 'End':
            ev.preventDefault();
            partsToFocus = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.h)(parts);
            break;
          case 'PageUp':
            ev.preventDefault();
            partsToFocus = ev.shiftKey ? (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.I)(parts) : (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.c)(parts);
            break;
          case 'PageDown':
            ev.preventDefault();
            partsToFocus = ev.shiftKey ? (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.H)(parts) : (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.d)(parts);
            break;
          /**
    ...
    this.processMinParts = () => {
      ...
      const { month, day, year, hour, minute } = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.p)(this.min);
      this.minParts = {
        month,
        day,
        year,
    ...
    this.processMaxParts = () => {
      ...
      const { month, day, year, hour, minute } = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.p)(this.max);
      this.maxParts = {
        month,
        day,
        year,
    ...
    this.initializeCalendarListener = () => {
      ...
      (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.c)(() => {
        ...
        const getChangedMonth = (parts) => {
           ...
           */
          if (month === startMonth) {
            return (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.c)(parts);
          }
          else if (month === endMonth) {
            return (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.d)(parts);
          }
          else {
            return;
          }
    ...
    this.processValue = (value) => {
      ...
      let valueToProcess = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.p)(value || (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.e)());
      const { minParts, maxParts, multiple } = this;
      if (!multiple && Array.isArray(value)) {
        this.value = value[0];
        valueToProcess = valueToProcess[0];
      }
      (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.w)(valueToProcess, minParts, maxParts);
      /**
      ...
      const { month, day, year, hour, minute, tzOffset } = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.J)(singleValue, minParts, maxParts);
      const ampm = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.K)(hour);
  ...
  yearValuesChanged() {
    this.parsedYearValues = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.o)(this.yearValues);
  }
  monthValuesChanged() {
    this.parsedMonthValues = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.o)(this.monthValues);
  }
  dayValuesChanged() {
    this.parsedDayValues = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.o)(this.dayValues);
  }
  hourValuesChanged() {
    this.parsedHourValues = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.o)(this.hourValues);
  }
  minuteValuesChanged() {
    this.parsedMinuteValues = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.o)(this.minuteValues);
  }
  activePartsChanged() {
  ...
  valueChanged() {
    ...
    if (this.hasValue()) {
       ...
       */
      const valueDateParts = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.p)(value);
      if (valueDateParts) {
        (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.w)(valueDateParts, minParts, maxParts);
    ...
    if (highlightActiveParts || !isCalendarPicker) {
      ...
      if (activePartsIsArray && activeParts.length === 0) {
        ...
        if (activePartsIsArray) {
          const dates = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.q)(activeParts).map((str) => new Date(str));
          for (let i = 0; i < dates.length; i++) {
            activeParts[i].tzOffset = dates[i].getTimezoneOffset() * -1;
          }
        }
        else {
          const date = new Date((0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.q)(activeParts));
          activeParts.tzOffset = date.getTimezoneOffset() * -1;
        }
        this.value = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.q)(activeParts);
      }
    }
    if (closeOverlay) {
      this.closeParentOverlay();
  ...
  componentDidLoad() {
     ...
     */
    (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => visibleIO === null || visibleIO === void 0 ? void 0 : visibleIO.observe(this.el));
    /**
    ...
    (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => hiddenIO === null || hiddenIO === void 0 ? void 0 : hiddenIO.observe(this.el));
    /**
     ...
     * events at a time.
     */
    const root = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el);
  ...
  renderFooter() {
     ...
     */
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "datetime-footer" }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "datetime-buttons" }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: {
        ['datetime-action-buttons']: true,
        ['has-clear-button']: this.showClearButton,
      } }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "buttons" }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-buttons", null, showDefaultButtons && ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-button", { id: "cancel-button", color: this.color, onClick: () => this.cancel(true) }, this.cancelText)), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, showClearButton && ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-button", { id: "clear-button", color: this.color, onClick: () => clearButtonClick() }, this.clearText)), showDefaultButtons && ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-button", { id: "confirm-button", color: this.color, onClick: () => this.confirm(true) }, this.doneText)))))))));
  }
  /**
  ...
  renderWheelPicker(forcePresentation = this.presentation) {
    ...
    return (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-picker-internal", null, renderArray);
  }
  ...
  renderCombinedDatePickerColumn() {
     ...
     */
    const monthsToRender = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.C)(workingParts);
    /**
    ...
    const result = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.r)(locale, workingParts, todayParts, min, max, this.parsedDayValues, this.parsedMonthValues);
    ...
    if (isDateEnabled) {
      items = items.map((itemObject, index) => {
        ...
        try {
           ...
           */
          disabled = !isDateEnabled((0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.q)(referenceParts));
        }
        catch (e) {
    ...
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-picker-column-internal", { class: "date-column", color: this.color, items: items, value: todayString, onIonChange: (ev) => {
  ...
  renderIndividualDatePickerColumns(forcePresentation) {
    ...
    const months = shouldRenderMonths
      ? (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.s)(this.locale, workingParts, this.minParts, this.maxParts, this.parsedMonthValues)
      : [];
    const shouldRenderDays = forcePresentation === 'date';
    let days = shouldRenderDays
      ? (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.t)(this.locale, workingParts, this.minParts, this.maxParts, this.parsedDayValues)
      : [];
    if (isDateEnabled) {
    ...
    const years = shouldRenderYears
      ? (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.u)(this.todayParts, this.minParts, this.maxParts, this.parsedYearValues)
      : [];
  ...
  renderDayPickerColumn(days) {
    ...
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-picker-column-internal", { class: "day-column", color: this.color, items: days, value: (_a = (workingParts.day || this.todayParts.day)) !== null && _a !== void 0 ? _a : undefined, onIonChange: (ev) => {
        // TODO(FW-1823) Remove this when iOS 14 support is dropped.
        // Due to a Safari 14 issue we need to destroy
        // the scroll listener before we update state
        // and trigger a re-render.
  ...
  renderMonthPickerColumn(months) {
    ...
    const { activeParts, workingParts } = this;
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-picker-column-internal", { class: "month-column", color: this.color, items: months, value: workingParts.month, onIonChange: (ev) => {
        // TODO(FW-1823) Remove this when iOS 14 support is dropped.
        // Due to a Safari 14 issue we need to destroy
        // the scroll listener before we update state
        // and trigger a re-render.
  ...
  renderYearPickerColumn(years) {
    ...
    const { activeParts, workingParts } = this;
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-picker-column-internal", { class: "year-column", color: this.color, items: years, value: workingParts.year, onIonChange: (ev) => {
        // TODO(FW-1823) Remove this when iOS 14 support is dropped.
        // Due to a Safari 14 issue we need to destroy
        // the scroll listener before we update state
        // and trigger a re-render.
  ...
  renderTimePickerColumns(forcePresentation) {
    ...
    const { hoursData, minutesData, dayPeriodData } = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.v)(this.locale, this.workingParts, this.hourCycle, this.value ? this.minParts : undefined, this.value ? this.maxParts : undefined, this.parsedHourValues, this.parsedMinuteValues);
    return [
  ...
  renderHourPickerColumn(hoursData) {
    ...
    if (hoursData.length === 0)
      return [];
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-picker-column-internal", { color: this.color, value: activePartsClone.hour, items: hoursData, numericInput: true, onIonChange: (ev) => {
  ...
  renderMinutePickerColumn(minutesData) {
    ...
    if (minutesData.length === 0)
      return [];
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-picker-column-internal", { color: this.color, value: activePartsClone.minute, items: minutesData, numericInput: true, onIonChange: (ev) => {
  ...
  renderDayPeriodPickerColumn(dayPeriodData) {
    ...
    const isDayPeriodRTL = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.x)(this.locale);
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-picker-column-internal", { style: isDayPeriodRTL ? { order: '-1' } : {}, color: this.color, value: activePartsClone.ampm, items: dayPeriodData, onIonChange: (ev) => {
        const hour = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.L)(workingParts, ev.detail.value);
  ...
  renderWheelView(forcePresentation) {
    const { locale } = this;
    const showMonthFirst = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.y)(locale);
    const columnOrder = showMonthFirst ? 'month-first' : 'year-first';
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: {
  ...
  renderCalendarHeader(mode) {
    const expandedIcon = mode === 'ios' ? _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_1__.l : _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_1__.p;
    const collapsedIcon = mode === 'ios' ? _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_1__.o : _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_1__.q;
    const prevMonthDisabled = isPrevMonthDisabled(this.workingParts, this.minParts, this.maxParts);
    const nextMonthDisabled = isNextMonthDisabled(this.workingParts, this.maxParts);
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "calendar-header" }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "calendar-action-buttons" }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "calendar-month-year" }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-item", { button: true, detail: false, lines: "none", onClick: () => this.toggleMonthAndYearView() }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-label", null, (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.A)(this.locale, this.workingParts), ' ', (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", { icon: this.showMonthAndYear ? expandedIcon : collapsedIcon, lazy: false })))), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "calendar-next-prev" }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-buttons", null, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-button", { disabled: prevMonthDisabled, onClick: () => this.prevMonth() }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", { slot: "icon-only", icon: _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_1__.c, lazy: false, flipRtl: true })), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-button", { disabled: nextMonthDisabled, onClick: () => this.nextMonth() }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", { slot: "icon-only", icon: _index_45ecc7ca_js__WEBPACK_IMPORTED_MODULE_1__.o, lazy: false, flipRtl: true }))))), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "calendar-days-of-week" }, (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.z)(this.locale, mode, this.firstDayOfWeek % 7).map((d) => {
      return (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "day-of-week" }, d);
    }))));
  }
  renderMonth(month, year) {
    ...
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: {
      ...
      } }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "calendar-month-grid" }, (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.B)(month, year, this.firstDayOfWeek % 7).map((dateObject, index) => {
      ...
      if (!isCalDayDisabled && isDateEnabled !== undefined) {
        try {
           ...
           * interrupting the calendar rendering.
           */
          isCalDayDisabled = !isDateEnabled((0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.q)(referenceParts));
        }
        catch (e) {
          (0,_index_c4b11676_js__WEBPACK_IMPORTED_MODULE_5__.b)('Exception thrown from provided `isDateEnabled` function. Please check your function and try again.', e);
        }
      }
      return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { tabindex: "-1", "data-day": day, "data-month": month, "data-year": year, "data-index": index, "data-day-of-week": dayOfWeek, disabled: isCalDayDisabled, class: {
  ...
  renderCalendarBody() {
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "calendar-body ion-focusable", ref: (el) => (this.calendarBodyRef = el), tabindex: "0" }, (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.C)(this.workingParts).map(({ month, year }) => {
      return this.renderMonth(month, year);
    })));
  }
  renderCalendar(mode) {
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "datetime-calendar" }, this.renderCalendarHeader(mode), this.renderCalendarBody()));
  }
  renderTimeLabel() {
    ...
    return (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "time-label" }, "Time");
  }
  renderTimeOverlay() {
    const use24Hour = (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.D)(this.locale, this.hourCycle);
    return [
      (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "time-header" }, this.renderTimeLabel()),
      (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { class: {
          'time-body': true,
        ...
        } }, (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.E)(this.locale, this.activePartsClone, use24Hour)),
      (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-popover", { alignment: "center", translucent: true, overlayIndex: 1, arrow: false, onWillPresent: (ev) => {
          /**
  ...
  renderCalendarViewHeader(mode) {
    ...
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "datetime-header" }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "datetime-title" }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "title" }, "Select Date")), mode === 'md' && !this.multiple && ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "datetime-selected-date" }, (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.F)(this.locale, this.activeParts)))));
  }
  /**
  ...
  renderTime() {
    ...
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "datetime-time" }, timeOnlyPresentation ? this.renderWheelPicker() : this.renderTimeOverlay()));
  }
  /**
  ...
  renderCalendarViewMonthYearPicker() {
    return (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "datetime-year" }, this.renderWheelView('month-year'));
  }
  /**
   * Render entry point
  ...
  render() {
    ...
    (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.e)(true, el, name, (0,_parse_d395420d_js__WEBPACK_IMPORTED_MODULE_8__.G)(value), disabled);
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.H, { "aria-disabled": disabled ? 'true' : null, onFocus: this.onFocus, onBlur: this.onBlur, class: Object.assign({}, (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_7__.c)(color, {
        [mode]: true,
...
const Picker = class {
  constructor(hostRef) {
    (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);
    this.didPresent = (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionPickerDidPresent", 7);
    this.willPresent = (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionPickerWillPresent", 7);
    this.willDismiss = (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionPickerWillDismiss", 7);
    this.didDismiss = (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionPickerDidDismiss", 7);
   ...
   */
  async present() {
    await (0,_overlays_ab6211c7_js__WEBPACK_IMPORTED_MODULE_9__.d)(this, 'pickerEnter', iosEnterAnimation, iosEnterAnimation, undefined);
    if (this.duration > 0) {
  ...
  async callButtonHandler(button) {
    if (button) {
      ...
      const rtn = await (0,_overlays_ab6211c7_js__WEBPACK_IMPORTED_MODULE_9__.s)(button.handler, this.getSelected());
      if (rtn === false) {
  ...
  render() {
    ...
    const mode = (0,_ionic_global_00475c3a_js__WEBPACK_IMPORTED_MODULE_2__.b)(this);
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.H, Object.assign({ "aria-modal": "true", tabindex: "-1" }, htmlAttributes, { style: {
        zIndex: `${20000 + this.overlayIndex}`,
      }, class: Object.assign({ [mode]: true,
        // Used internally for styling
        [`picker-${mode}`]: true, 'overlay-hidden': true }, (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.cssClass)), onIonBackdropTap: this.onBackdropTap, onIonPickerWillDismiss: this.dispatchCancelHandler }), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-backdrop", { visible: this.showBackdrop, tappable: this.backdropDismiss }), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { tabindex: "0" }), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-wrapper ion-overlay-wrapper", role: "dialog" }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-toolbar" }, this.buttons.map((b) => ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: buttonWrapperClass(b) }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", onClick: () => this.buttonClick(b), class: buttonClass(b) }, b.text))))), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-columns" }, (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-above-highlight" }), this.presented && this.columns.map((c) => (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-picker-column", { col: c })), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-below-highlight" }))), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { tabindex: "0" })));
  }
  get el() { return (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.i)(this); }
};
...
const PickerColumnCmp = class {
  constructor(hostRef) {
    (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);
    this.ionPickerColChange = (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionPickerColChange", 7);
    this.optHeight = 0;
    this.rotateFactor = 0;
    this.scaleFactor = 1;
    this.velocity = 0;
  ...
  async connectedCallback() {
    ...
    this.gesture = (await Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-3f1a7d95.js */ 2503))).createGesture({
      el: this.el,
  ...
  onStart(detail) {
    ...
    (0,_haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_11__.a)();
    // reset everything
    cancelAnimationFrame(this.rafId);
  ...
  onEnd(detail) {
    ...
    this.velocity = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.l)(-MAX_PICKER_SPEED, detail.velocityY * 23, MAX_PICKER_SPEED);
  ...
  refresh(forceRefresh) {
    ...
    const selectedIndex = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.l)(min, this.col.selectedIndex || 0, max);
  ...
  render() {
    ...
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.H, { class: {
      ...
      } }, col.prefix && ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-prefix", style: { width: col.prefixWidth } }, col.prefix)), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-opts", style: { maxWidth: col.optionsWidth }, ref: (el) => (this.optsEl = el) }, col.options.map((o, index) => ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)(Button, { type: "button", class: { 'picker-opt': true, 'picker-opt-disabled': !!o.disabled }, "opt-index": index }, o.text)))), col.suffix && ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-suffix", style: { width: col.suffixWidth } }, col.suffix))));
  }
  get el() { return (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.i)(this); }
  static get watchers() { return {
    "col": ["colChanged"]
